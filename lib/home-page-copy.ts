...
export const homeContentByLocale: Record<Locale, HomeContent> = {
  ...
  sv: {
    ...
    howSteps: [{ step: "1", title: "Skaka", text: "Aktivera extraktet före varje användning." }, { step: "2", title: "Spraya", text: "Använd 3 till 4 spray under tungan." }, { step: "3", title: "Var konsekvent", text: "Använd dagligen i 2 till 4 veckor för att känna hela rutinen." }],
    ...
    faqs: [
      ...
      { question: "Hur använder jag sprayerna varje dag?", answer: "Skaka flaskan, spraya 3 till 4 gånger under tungan, håll kort och använd konsekvent som en del av din dagliga rutin." },
