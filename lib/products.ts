...
const localeExpansions: Record<ProductSlug, { ru: ProductCopy; sv: ProductCopy }> = {
  "lions-mane": {
    ru: {
      ...
      usage: ["Встряхнуть перед использованием", "Распылить 5-7 раз под язык", "Подержать 30 секунд и проглотить"],
    ...
    sv: {
      ...
      usage: ["Skaka före användning", "Spraya 5-7 gånger under tungan", "Håll i 30 sekunder och svälj"],
  ...
  cordyceps: {
    ru: {
      ...
      usage: ["Встряхнуть перед использованием", "Распылить 5-7 раз под язык", "Использовать утром или перед активностью"],
    ...
    sv: {
      ...
      usage: ["Skaka före användning", "Spraya 5-7 gånger under tungan", "Använd på morgonen eller före aktivitet"],
  ...
  reishi: {
    ru: {
      ...
      usage: ["Встряхнуть перед использованием", "Распылить 5-7 раз под язык", "Использовать вечером"],
    ...
    sv: {
      ...
      usage: ["Skaka före användning", "Spraya 5-7 gånger under tungan", "Använd på eftermiddagen eller kvällen"],
  ...
  shiitake: {
    ru: {
      ...
      usage: ["Встряхнуть перед использованием", "Распылить 5-7 раз под язык", "Использовать ежедневно в любое время"],
    ...
    sv: {
      ...
      usage: ["Skaka före användning", "Spraya 5-7 gånger under tungan", "Använd dagligen när som helst"],
  ...
  chaga: {
    ru: {
      ...
      usage: ["Встряхнуть перед использованием", "Распылить 5-7 раз под язык", "Использовать утром как часть рутины"],
    ...
    sv: {
      ...
      usage: ["Skaka före användning", "Spraya 5-7 gånger under tungan", "Använd på morgonen som del av rutinen"],
  ...
  mix: {
    ru: {
      ...
      usage: ["Встряхнуть перед использованием", "Распылить 5-7 раз под язык", "Использовать один или два раза в день"],
    ...
    sv: {
      ...
      usage: ["Skaka före användning", "Spraya 5-7 gånger under tungan", "Använd en eller två gånger dagligen"],
  ...
  product({
    ...
    localized: {
      en: {
        ...
        usage: [
          "Shake before use",
          "Spray 5-7 times under the tongue",
